...
func main() {
	...
	roads := [][]int{{0, 1}, {1, 6}, {3, 6}, {2, 3}, {2, 4}, {4, 5}, {6, 5}, {6, 7}, {8, 7}, {8, 12}, {8, 9}, {10, 9},
		{12, 11}, {12, 9}, {16, 15}, {15, 14}, {14, 13}, {14, 19}, {19, 13}, {20, 19}, {21, 19}, {22, 19}, {23, 19},
		{24, 19}, {13, 17}, {17, 18}, {13, 6}, {18, 12}}
